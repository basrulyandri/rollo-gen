            ...
            <div class="col-lg-4">
                ...
                <div class="ibox-tools">                    
                    ...
                    <ul class="dropdown-menu dropdown-user">
                        <li><a href="{{route('user.edit',$user)}}"><i class="fa fa-edit"></i> Edit</a>
                        </li>
                        <li><a user-id="{{$user->id}}" class="hapus" href="#"><i class="fa fa-trash"></i> Hapus</a>
                        </li>
                    </ul>                    
                </div>
                    ...
                    <div class="col-sm-4">
                        <div class="text-center">
                            ...
                            <div class="m-t-xs font-bold" style="min-height: 60px;">{{$user->role->name}}</div>
                        </div>
                    </div>
                    <div class="col-sm-8">
